...
class TeacherController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('teacher.teacher_display',['teacher_data' => $teacher_data]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('/teachers')->with('success', 'Data Berhasil Diubah');
    }
    ...
    public function destroy($id)
    {
        $teacher = \App\Teacher::find($id);
        $teacher->delete();
        return redirect('/teachers')->with('success', 'Data berhasil dihapus');
    }
}
